...
var updateDefaultAppearance = function (field, color, font, fontSize) {
    ...
    var da = [
        (_a = colors_1.setFillingColorspaceOrUndefined(color)) === null || _a === void 0 ? void 0 : _a.toString(),
        colors_1.setFillingColor(color).toString(),
        operators_1.setFontAndSize((_b = font === null || font === void 0 ? void 0 : font.name) !== null && _b !== void 0 ? _b : 'dummy__noop', fontSize).toString(),
    ]
        .filter(Boolean)
        .join('\n');
