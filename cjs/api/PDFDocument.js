...
var PDFSeparation_1 = tslib_1.__importDefault(require("./PDFSeparation"));
...
var PDFDocument = /** @class */ (function () {
    ...
    PDFDocument.prototype.embedSeparation = function (name, alternate) {
        ...
        var alternateColorComponents = colors_1.colorToComponents(alternate);
        var embedder = core_1.SeparationEmbedder.for(name, alternateColorSpace, alternateColorComponents);
        var separation = PDFSeparation_1.default.of(ref, this, embedder);
...
var getColorSpace = function (color) {
    return color.type === colors_1.ColorTypes.Grayscale ? 'DeviceGray'
        : color.type === colors_1.ColorTypes.RGB ? 'DeviceRGB'
            : color.type === colors_1.ColorTypes.CMYK ? 'DeviceCMYK'
                : utils_1.error("Invalid alternate color: " + JSON.stringify(color));
};
