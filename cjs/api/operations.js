...
exports.drawText = function (line, options) {
    return [
        ...
        colors_1.setFillingColorspaceOrUndefined(options.color),
...
exports.drawLine = function (options) {
    ...
    return [
        operators_1.pushGraphicsState(),
        options.graphicsState && operators_1.setGraphicsState(options.graphicsState),
        options.color && colors_1.setStrokingColorspaceOrUndefined(options.color),
...
exports.drawRectangle = function (options) {
    ...
    return [
        operators_1.pushGraphicsState(),
        options.graphicsState && operators_1.setGraphicsState(options.graphicsState),
        options.color && colors_1.setFillingColorspaceOrUndefined(options.color),
        options.color && colors_1.setFillingColor(options.color),
        options.borderColor &&
            colors_1.setStrokingColorspaceOrUndefined(options.borderColor),
