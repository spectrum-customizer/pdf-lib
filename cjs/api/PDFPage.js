...
var PDFPage = /** @class */ (function () {
     ...
     */
    PDFPage.prototype.getSeparationColor = function (pdfSeparation, tint) {
        var name = pdfSeparation.name;
        var ref = pdfSeparation.ref;
        return colors_1.separation(this.node.newColorSpace(name, ref), tint);
    };
    /**
    ...
    PDFPage.prototype.drawText = function (text, options) {
        ...
        utils_1.assertOrUndefined(options.overprint, 'options.overprint', ['boolean']);
    ...
    PDFPage.prototype.drawSvgPath = function (path, options) {
        ...
        var contentStream = this.getContentStream();
        var pathContent = operations_1.drawSvgPath(path, {
            x: (_a = options.x) !== null && _a !== void 0 ? _a : this.x,
            y: (_b = options.y) !== null && _b !== void 0 ? _b : this.y,
            scale: options.scale,
            rotate: (_c = options.rotate) !== null && _c !== void 0 ? _c : rotations_1.degrees(0),
    ...
    PDFPage.prototype.maybeEmbedGraphicsState = function (options) {
        var opacity = options.opacity, borderOpacity = options.borderOpacity, blendMode = options.blendMode, overprint = options.overprint, nonStrokingOverprint = options.nonStrokingOverprint;
