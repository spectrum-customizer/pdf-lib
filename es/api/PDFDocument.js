...
import { CustomFontEmbedder, CustomFontSubsetEmbedder, JpegEmbedder, PageEmbeddingMismatchedContextError, PDFCatalog, PDFContext, PDFDict, PDFHexString, PDFName, PDFObjectCopier, PDFPageEmbedder, PDFPageLeaf, PDFPageTree, PDFParser, PDFStreamWriter, PDFString, PDFWriter, PngEmbedder, StandardFontEmbedder, SeparationEmbedder, UnexpectedObjectTypeError, } from "../core";
import { ParseSpeeds, } from "./PDFDocumentOptions";
import { assertIs, assertIsOneOfOrUndefined, assertOrUndefined, assertRange, Cache, canBeConvertedToUint8Array, encodeToBase64, isStandardFont, pluckIndices, range, toUint8Array, error, } from "../utils";
...
import { ColorTypes, colorToComponents } from './colors';
/**
...
var PDFDocument = /** @class */ (function () {
     ...
     *                  color.
     */
    PDFDocument.prototype.embedSeparation = function (name, alternate) {
        var ref = this.context.nextRef();
        var alternateColorSpace = getColorSpace(alternate);
        var alternateColorComponents = colorToComponents(alternate);
        var embedder = SeparationEmbedder.for(name, alternateColorSpace, alternateColorComponents);
        var separation = PDFSeparation.of(ref, this, embedder);
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.embedAll(this.separationColorSpaces)];
                    case 3:
                        _a.sent();
...
// prettier-ignore
var getColorSpace = function (color) {
    return color.type === ColorTypes.Grayscale ? 'DeviceGray'
